...
-- --------------------------------------------------
-- Date Created: 09/24/2020 18:29:48
-- Generated from EDMX file: C:\Users\Alekz\Desktop\APPI test\ProyectoBodegav02\Models\DB.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK__Empleado__fk_idP__534D60F1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Empleado] DROP CONSTRAINT [FK__Empleado__fk_idP__534D60F1];
GO
IF OBJECT_ID(N'[dbo].[FK__Inventari__fk_Pr__02FC7413]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Inventario] DROP CONSTRAINT [FK__Inventari__fk_Pr__02FC7413];
GO
IF OBJECT_ID(N'[dbo].[FK__Pedido__fk_idEmp__5629CD9C]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Pedido] DROP CONSTRAINT [FK__Pedido__fk_idEmp__5629CD9C];
GO
IF OBJECT_ID(N'[dbo].[FK__Pedido_Pr__fk_Pe__59063A47]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Pedido_Producto] DROP CONSTRAINT [FK__Pedido_Pr__fk_Pe__59063A47];
GO
IF OBJECT_ID(N'[dbo].[FK__Pedido_Pr__fk_Pr__59FA5E80]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Pedido_Producto] DROP CONSTRAINT [FK__Pedido_Pr__fk_Pr__59FA5E80];
GO
IF OBJECT_ID(N'[dbo].[FK__Producto__fk_idC__4E88ABD4]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Producto] DROP CONSTRAINT [FK__Producto__fk_idC__4E88ABD4];
GO
IF OBJECT_ID(N'[dbo].[FK__Producto__fk_idP__4D94879B]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Producto] DROP CONSTRAINT [FK__Producto__fk_idP__4D94879B];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Pedido_Producto]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Pedido_Producto];
GO
